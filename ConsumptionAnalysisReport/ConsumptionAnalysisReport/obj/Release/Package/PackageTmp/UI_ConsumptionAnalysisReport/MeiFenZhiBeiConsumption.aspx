<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeiFenZhiBeiConsumption.aspx.cs" Inherits="ConsumptionAnalysisReport.UI_ConsumptionAnalysisReport.MeiFenZhiBeiConsumption" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="js/page/MeiFenZhiBeiConsumption.js" charset="utf-8"></script>
</head>
<body>
            ...
            <div id="TableContentDiv">
                ...
                <div>
                    <div id="toolbar_ReportTable" style="display: none; text-align: center; vertical-align: middle; height: 30px; padding-top: 7px;">
                        <span style="font-size: 18pt; color:white; font-weight:bold; font-family:SimHei">煤粉制备系统电耗对比分析</span>
                    </div>
