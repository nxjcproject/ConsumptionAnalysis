...
function LoadDataGrid(myData) {
    $('#DataGrid_ReportTable').datagrid({
        ...
        columns: [[
           ...
           [{ width: '80', title: firstMonthTitle, field: '1', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(0, value, row, index); } },
           { width: '80', title: secondMonthTitle, field: '2', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
           { width: '80', title: thirdMonthTitle, field: '3', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(2, value, row, index); } },
           { width: '80', title: firstMonthTitle, field: '4', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(3, value, row, index); } },
           { width: '80', title: secondMonthTitle, field: '5', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(4, value, row, index); } },
           { width: '80', title: thirdMonthTitle, field: '6', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(5, value, row, index); } },
           { width: '80', title: firstMonthTitle, field: '7', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(6, value, row, index); } },
           { width: '80', title: secondMonthTitle, field: '8', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(7, value, row, index); } },
           { width: '80', title: thirdMonthTitle, field: '9', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(8, value, row, index); } }
           ]],
