...
function QueryReportFun() {
    ...
    $.ajax({
        type: "POST",
        url: "FeiQiChuLiConsumption.aspx/GetFeiQiChuLiConsumption",
...
function SetDivPosization(myWidth) {
    //var m_TableWidth = $('#DataGrid_ReportTable').width();
    $('#TableContentDiv').css('margin-left', myWidth > 508 ? parseInt((myWidth - 508) / 2) : 0);

    //if (myWidth > 508) {           //当窗口比div大
    //    $('#TableContentDiv').css('margin-left', parseInt((myWidth - 508) / 2));
    //}
    //else {
