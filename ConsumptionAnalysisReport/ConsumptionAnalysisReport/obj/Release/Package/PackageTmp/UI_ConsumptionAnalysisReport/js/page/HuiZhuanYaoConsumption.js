...
function LoadDataGrid(myData) {
    $('#DataGrid_ReportTable').datagrid({
        ...
        columns: [[
           { width: '90', title: '公司名称', field: 'CompanyName', rowspan: 2, align: 'center', styler: cellStyler_lightgray },
           { width: '60', title: '生产线', field: 'ProductionLine', rowspan: 2, align: 'center', styler: cellStyler_lightgray },
           { width: '210', title: '原料处理', colspan: 3, align: 'center'},
           { width: '225', title: '生料粉磨', colspan: 3, align: 'center' },
           { width: '225', title: '煤粉制备', colspan: 3, align: 'center' },
           { width: '225', title: '熟料烧成', colspan: 3, align: 'center' },
           { width: '225', title: '废气处理', colspan: 3, align: 'center' }],
           [{ width: '75', title: firstMonthTitle, field: '1month9', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(0, value, row, index); } },
           { width: '75', title: secondMonthTitle, field: '1month10', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
           { width: '75', title: thirdMonthTitle, field: '1month11', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(2, value, row, index); } },
           { width: '75', title: firstMonthTitle, field: '2month9', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(3, value, row, index); } },
           { width: '75', title: secondMonthTitle, field: '2month10', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(4, value, row, index); } },
           { width: '75', title: thirdMonthTitle, field: '2month11', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(5, value, row, index); } },
           { width: '75', title: firstMonthTitle, field: '3month9', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(6, value, row, index); } },
           { width: '75', title: secondMonthTitle, field: '3month10', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(7, value, row, index); } },
           { width: '75', title: thirdMonthTitle, field: '3month11', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(8, value, row, index); } },
           { width: '75', title: firstMonthTitle, field: '4month9', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(9, value, row, index); } },
           { width: '75', title: secondMonthTitle, field: '4month10', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(10, value, row, index); } },
           { width: '75', title: thirdMonthTitle, field: '4month11', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(11, value, row, index); } },
           { width: '75', title: firstMonthTitle, field: '5month9', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(12, value, row, index); } },
           { width: '75', title: secondMonthTitle, field: '5month10', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(13, value, row, index); } },
           { width: '75', title: thirdMonthTitle, field: '5month11', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(14, value, row, index); } }]],
    ...
    if (myData != undefined && myData != null && myData["rows"] != undefined && myData["rows"] != null) {
        ...
        for (var i = 0; i < myData["rows"].length; i++) {
            for (var j = 0; j < MaxColumnCount; j++) {
                var m_ColumnNameTemp = (parseInt(j / 3) + 1).toString() + "month" + (j % 3 + 9).toString()
                var m_ValueTemp = myData["rows"][i][m_ColumnNameTemp];
                if (m_ValueTemp != "") {
...
function setColumnBacakground(myColumnIndex) {
    ...
    else if (myColumnIndex >= 9 && myColumnIndex <= 11) {
        return cellStyler_Lightpurple();
    }
    else if (myColumnIndex >= 12 && myColumnIndex <= 14) {
        return cellStyler_Lightorange();
    }
}
...
function SetDivPosization(myWidth) {
    ...
    if (myWidth > 1303) {           //当窗口比div大
        $('#TableContentDiv').css('margin-left', parseInt((myWidth - 1303) / 2));
    }
    else {
