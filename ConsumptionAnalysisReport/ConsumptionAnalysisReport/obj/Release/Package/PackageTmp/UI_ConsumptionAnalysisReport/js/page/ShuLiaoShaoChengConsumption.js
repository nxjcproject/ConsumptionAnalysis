...
function QueryReportFun() {
    ...
    $.ajax({
        type: "POST",
        url: "ShuLiaoShaoChengConsumption.aspx/GetConsumptionAnalysisInfo",
        data: '{mySelectTime: "' + m_SelectTime + '"}',
...
function LoadDataGrid(myData) {
    $('#DataGrid_ReportTable').datagrid({
        ...
        columns: [[
           ...
           { width: '80', title: '生产线', field: 'ProductionLine', align: 'center', styler: cellStyler_crossred },
           { width: '80', title: '熟料烧成', field: 'A1', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(0, value, row, index); } },
           { width: '80', title: '窑主机', field: 'A2', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
           { width: '100', title: '均化库风机', field: 'A3', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(2, value, row, index); } },
           { width: '100', title: '入窑提升机', field: 'A4', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(3, value, row, index); } },
           { width: '80', title: '一次风机', field: 'A5', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(4, value, row, index); } },
           { width: '80', title: '送煤风机', field: 'A6', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(5, value, row, index); } },
           { width: '80', title: '高温风机', field: 'A7', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(6, value, row, index); } },
           { width: '80', title: '头排风机', field: 'A8', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(7, value, row, index); } },
           { width: '100', title: '篦冷机风机', field: 'A9', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(8, value, row, index); } }]],
...
function SetDivPosization(myWidth) {
    ...
    if (myWidth > 1008) {           //当窗口比div大
        $('#TableContentDiv').css('margin-left', parseInt((myWidth - 1008) / 2));
    }
    else {
...
function ExportFileFun() {
    ...
    var m_Parameter1 = GetDataGridTableHtml("DataGrid_ReportTable", "熟料烧成电耗对比分析", m_SelectTime);
    var m_Parameter2 = "";
    ...
    form.attr('action', "ShuLiaoShaoChengConsumption.aspx");
