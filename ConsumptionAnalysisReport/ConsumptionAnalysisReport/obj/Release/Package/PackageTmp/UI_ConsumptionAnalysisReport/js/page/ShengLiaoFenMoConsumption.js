...
function LoadDataGrid(myData) {
    $('#DataGrid_ReportTable').datagrid({
        ...
        columns: [[
           ...
           { width: '120', title: '生料粉磨', field: '1', colspan: 1, align: 'center', styler: function (value, row, index) { return SetBackgroundColor(0, value, row, index); } },
            { width: '120', title: '磨机', field: '2', colspan: 1, align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
            { width: '120', title: '循环风机', field: '3', colspan: 1, align: 'center', styler: function (value, row, index) { return SetBackgroundColor(2, value, row, index); } },
        ]],
