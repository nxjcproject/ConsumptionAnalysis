<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShengLiaoZhiBeiConsumption.aspx.cs" Inherits="ConsumptionAnalysisReport.UI_ConsumptionAnalysisReport.ShengLiaoZhiBeiConsumption" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="js/page/ShengLiaoZhiBeiConsumption.js" charset="utf-8"></script>
</head>
<body>
            ...
            <div id="TableContentDiv">
                ...
                <div>
                    <div id="toolbar_ReportTable" style="display: none; text-align: center; vertical-align: middle; height: 30px; padding-top: 7px;">
                        <span style="font-size: 18pt; color:white; font-weight:bold; font-family:SimHei">生料制备工序峰谷平用电分析</span>
                    </div>
                    <div data-options="border:false">
                        <table id="DataGrid_ReportTable" style="width: 1158px;"></table>
                    </div>
                </div>
            </div>
        </div>
