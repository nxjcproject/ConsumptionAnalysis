<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShuLiaoShaoChengConsumption.aspx.cs" Inherits="ConsumptionAnalysisReport.UI_ConsumptionAnalysisReport.ShuLiaoShaoChengConsumption" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>熟料烧成电耗对比分析</title>
    <link rel="stylesheet" type="text/css" href="/lib/ealib/themes/custom/easyui_datagrid_red.css" />
    ...
    <script type="text/javascript" src="js/page/ShuLiaoShaoChengConsumption.js" charset="utf-8"></script>
</head>
<body>
            ...
            <div id="TableContentDiv">
                ...
                <div>
                    <div id="toolbar_ReportTable" style="display: none; text-align: center; vertical-align: middle; height: 30px; padding-top: 7px;">
                        <span style="font-size: 18pt; color:white; font-weight:bold; font-family:SimHei">熟料烧成电耗对比分析</span>
                    </div>
                    <div data-options="border:false">
                        <table id="DataGrid_ReportTable" style="width: 1008px;"></table>
                    </div>
                </div>
            </div>
        </div>
