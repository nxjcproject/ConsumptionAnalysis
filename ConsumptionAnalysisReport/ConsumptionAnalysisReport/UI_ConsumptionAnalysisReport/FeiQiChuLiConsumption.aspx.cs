...
{
    public partial class FeiQiChuLiConsumption : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                FeiQiChuLiConsumptionService.ExportExcelFile("xls", m_Parameter2 + "废气处理系统电耗对比分析.xls", m_ExportTable);
            }
        }

        [WebMethod]
        public static string GetFeiQiChuLiConsumption(string mySelectTime)
        {
            DataTable table = FeiQiChuLiConsumptionService.GetFeiQiChuLiConsumption(mySelectTime);
