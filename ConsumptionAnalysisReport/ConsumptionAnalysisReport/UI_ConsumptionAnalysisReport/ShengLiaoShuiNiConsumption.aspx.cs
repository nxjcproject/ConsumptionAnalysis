    ...
    public partial class ShengLiaoShuiNiConsumption : WebStyleBaseForEnergy.webStyleBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                ShengLiaoShuiNiConsumptionService.ExportExcelFile("xls", m_Parameter2 + "生料制备、水泥制备峰谷平用电分析.xls", m_ExportTable);
            }
        }
        ...
        public static string GetConsumptionAnalysisInfo(string m_searchDate)
        {
            ...
            table.Columns.Remove("ProductLine");
            table.Columns.Remove("runLevel");
