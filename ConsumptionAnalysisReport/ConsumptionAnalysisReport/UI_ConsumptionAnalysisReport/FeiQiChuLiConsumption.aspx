<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeiQiChuLiConsumption.aspx.cs" Inherits="ConsumptionAnalysisReport.UI_ConsumptionAnalysisReport.FeiQiChuLiConsumption" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
   <title>废气处理系统电耗对比分析</title>
    ...
    <script type="text/javascript" src="js/page/FeiQiChuLiConsumption.js" charset="utf-8"></script>
</head>
<body>
            ...
            <div id="TableContentDiv">
                ...
                <div>
                    <div id="toolbar_ReportTable" style="display: none; text-align: center; vertical-align: middle; height: 30px; padding-top: 7px;">
                        <span style="font-size: 18pt; color:white; font-weight:bold; font-family:SimHei">废气处理系统电耗对比分析</span>
                    </div>
                    <div data-options="border:false">
                        <table id="DataGrid_ReportTable" style="width: 508px;"></table>
                    </div>
                </div>
            </div>
        </div>
