...
{
    public partial class ShengLiaoZhiBeiConsumption : WebStyleBaseForEnergy.webStyleBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                ShengLiaoZhiBeiConsumptionService.ExportExcelFile("xls", m_Parameter2 + "生料制备工序峰谷平用电分析.xls", m_ExportTable);
            }
        }
        ...
        public static string GetConsumptionAnalysisInfo(string m_searchDate)
        {
            ...
            DataTable table = ShengLiaoZhiBeiConsumptionService.GetRowMaterialProcessElectricityUsageByMonth(m_searchDate, m_OganizationIds.ToArray());
