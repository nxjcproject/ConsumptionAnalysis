...
function LoadDataGrid(myData) {
    $('#DataGrid_ReportTable').datagrid({
        ...
        columns: [[
           ...
           { width: '80', title: '熟料烧成', field: '1', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(0, value, row, index); } },
           { width: '80', title: '窑主机', field: '2', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
           { width: '100', title: '均化库风机', field: '3', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(2, value, row, index); } },
           { width: '100', title: '入窑提升机', field: '4', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(3, value, row, index); } },
           { width: '80', title: '一次风机', field: '5', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(4, value, row, index); } },
           { width: '80', title: '送煤风机', field: '6', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(5, value, row, index); } },
           { width: '80', title: '高温风机', field: '7', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(6, value, row, index); } },
           { width: '80', title: '头排风机', field: '8', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(7, value, row, index); } },
           { width: '100', title: '篦冷机风机', field: '9', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(8, value, row, index); } }]],
