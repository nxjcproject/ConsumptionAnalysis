...
function QueryReportFun() {
    ...
    $.ajax({
        type: "POST",
        url: "ShuiNiFenMoFengGuPingConsumption.aspx/GetShuiNiFenMoFengGuPingConsumption",
        data: dataToSend,
...
function LoadDataGrid(myData) {
    $('#DataGrid_ReportTable').datagrid({
        ...
        columns: [[
           ...
           { width: '100', title: '运转率(%)', field: 'runLevel', rowspan: 2, align: 'center', styler: function (value, row, index) { return SetBackgroundColor(0, value, row, index); } },
           { width: '320', title: '用电量', colspan: 4, align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
           ...
           [{ width: '120', title: '峰期', field: 'PeakB', align: 'center', styler: cellStyler_crossgreen },
            ...
            { width: '80', title: '峰期', field: 'PeakBproportion', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
            { width: '80', title: '谷期', field: 'ValleyBproportion', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(2, value, row, index); } },
            { width: '80', title: '平期', field: 'FlatBproportion', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(3, value, row, index); } }]],
...
function SetDivPosization(myWidth) {
    ...
    if (myWidth > 1058) {           //当窗口比div大
        $('#TableContentDiv').css('margin-left', parseInt((myWidth - 1058) / 2));
    }
    else {
...
function ExportFileFun() {
    ...
    var m_Parameter1 = GetDataGridTableHtml("DataGrid_ReportTable", "水泥制备峰谷平用电分析", m_searchDate);
    var m_Parameter2 = "";
    ...
    form.attr('action', "ShuiNiFenMoFengGuPingConsumption.aspx");
