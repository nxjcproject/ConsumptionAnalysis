...
function QueryReportFun() {
    ...
    $.ajax({
        type: "POST",
        url: "ShengLiaoFenMoConsumption.aspx/GetShengLiaoFenMoDianHao",
...
function LoadDataGrid(myData) {
    $('#DataGrid_ReportTable').datagrid({
        ...
        columns: [[
           { width: '120', title: '公司名称', field: 'CompanyName', rowspan: 1, align: 'center', styler: cellStyler_lightgray },
           { width: '120', title: '生产线', field: 'ProductionLine', rowspan: 1, align: 'center', styler: cellStyler_crossgreen },
           { width: '120', title: '生料粉磨', field: 'A1', colspan: 1, align: 'center', styler: function (value, row, index) { return SetBackgroundColor(0, value, row, index); } },
           { width: '120', title: '磨机', field: 'A2', colspan: 1, align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
           { width: '120', title: '循环风机', field: 'A3', colspan: 1, align: 'center', styler: function (value, row, index) { return SetBackgroundColor(2, value, row, index); } },
        ]],
...
function SetDivPosization(myWidth) {
    ...
    if (myWidth > 628) {           //当窗口比div大
        $('#TableContentDiv').css('margin-left', parseInt((myWidth - 628) / 2));
    }
    else {
...
function ExportFileFun() {
    ...
    var m_Parameter1 = GetDataGridTableHtml("DataGrid_ReportTable", "生料粉磨系统电耗对比分析", m_SelectTime);
    var m_Parameter2 = "";
    ...
    form.attr('action', "ShengLiaoFenMoConsumption.aspx");
