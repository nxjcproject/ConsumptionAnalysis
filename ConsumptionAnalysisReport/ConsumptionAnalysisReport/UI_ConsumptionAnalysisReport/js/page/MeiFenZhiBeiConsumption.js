...
function QueryReportFun() {
    ...
    $.ajax({
        type: "POST",
        url: "MeiFenZhiBeiConsumption.aspx/GetConsumptionAnalysisInfo",
...
function LoadDataGrid(myData) {
    $('#DataGrid_ReportTable').datagrid({
        ...
        columns: [[
           ...
           { width: '120', title: '生产线', field: 'ProductionLine', align: 'center', styler: cellStyler_crossgreen },
           { width: '120', title: '煤粉制备', field: 'A1', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(0, value, row, index); } },
           { width: '120', title: '磨主机', field: 'A2', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
           { width: '120', title: '通风机', field: 'A3', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(2, value, row, index); } }]],
...
function ExportFileFun() {
    ...
    var m_Parameter1 = GetDataGridTableHtml("DataGrid_ReportTable", "煤粉制备系统电耗对比分析", m_SelectTime);
    var m_Parameter2 = "";
    ...
    form.attr('action', "MeiFenZhiBeiConsumption.aspx");
