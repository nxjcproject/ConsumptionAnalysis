...
function LoadDataGrid(myData) {
    $('#DataGrid_ReportTable').datagrid({
        ...
        columns: [[
           ...
           { width: '120', title: '煤粉制备', field: '1', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(0, value, row, index); } },
           { width: '120', title: '磨主机', field: '2', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(1, value, row, index); } },
           { width: '120', title: '通风机', field: '3', align: 'center', styler: function (value, row, index) { return SetBackgroundColor(2, value, row, index); } }]],
